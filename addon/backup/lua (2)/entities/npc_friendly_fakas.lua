...
if CLIENT then
    ...
    local music = {
        inactive = create_track("fakas/friendly-npcs/fakas/inactive.wav"),
        active = create_track("fakas/friendly-npcs/fakas/active.wav"),
        chase = create_track("fakas/friendly-npcs/fakas/chase.wav")
    }
